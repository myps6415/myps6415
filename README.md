...
- **Personal automation self-hosting** *(June 2026)* — Migrated a Zeabur-hosted n8n workflow (daily family-schedule alert pushed to LINE) to a 178-line stdlib Python script triggered by local OpenClaw cron, **dropping the $7.88/month bill to $0** and consolidating onto the same scheduler already running 20 other cron jobs on the machine. Fixed a latent all-day-event crash bug as a side effect of the rewrite. [Full migration writeup →](https://myps6415.github.io/blog/from-n8n-zeabur-to-openclaw-local)
